export const csMessages = {
  ...
  dashboard: {
    ...
    infillPercent: "Výplň",
    wallThickness: "Tloušťka stěn",
    supportCoefficient: "Koeficient podpor",
    ...
    statusAvailableHelp: "Viditelný na mapě, přijímám nové objednávky",
    statusBusy: "Zaneprázdněný",
    statusBusyHelp: "Viditelný na mapě se šedým pinem, nepřijímám nové objednávky",
    statusHidden: "Skrytý",
    statusHiddenHelp: "Neviditelný na mapě, nepřijímám nové objednávky",
  ...
  model: {
    ...
    unsupportedFileType: "Podporujeme pouze soubory STL a OBJ.",
  ...
  statMakers: "Dílny",
  statMakersWithOrders: "{count} s objednávkami",
  workshopsTitle: "Registrované dílny",
  workshopColumnName: "Název",
  workshopColumnAddress: "Adresa",
  workshopColumnPrinters: "Tiskárny",
  workshopColumnRating: "Hodnocení",
  noWorkshops: "Žádné dílny",
  ...
  legal: {
    ...
    operatorDetails: "Provozovatel",
    menuLabel: "Právní info",
